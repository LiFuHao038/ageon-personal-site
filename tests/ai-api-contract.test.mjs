...
assert.match(aiApi, /let terminalEventReceived = false/)
assert.match(aiApi, /onclose\(\)/)
assert.match(aiApi, /AI_STREAM_INTERRUPTED/)
assert.match(aiApi, /options\.onError\(payload\)/)
